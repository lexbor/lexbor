...
TEST_BEGIN(decode)
{
    ...
    enc_data = lxb_encoding_data(LXB_ENCODING_KOI8_R);

    size = sizeof(lxb_encoding_single_index_koi8_r)
    ...
    for (size_t i = 0; i < size; i++) {
        ...
        entry = &lxb_encoding_single_index_koi8_r[i];
...
main(int argc, const char * argv[])
{
    ...
    TEST_RUN("lexbor/encoding/koi8_r");
    TEST_RELEASE();
}
