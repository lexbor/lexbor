...
TEST_BEGIN(decode)
{
    ...
    enc_data = lxb_encoding_data(LXB_ENCODING_IBM866);

    size = sizeof(lxb_encoding_single_index_ibm866)
    ...
    for (size_t i = 0; i < size; i++) {
        ...
        entry = &lxb_encoding_single_index_ibm866[i];
...
main(int argc, const char * argv[])
{
    ...
    TEST_RUN("lexbor/encoding/ibm866");
    TEST_RELEASE();
}
