...
TEST_BEGIN(decode)
{
    ...
    enc_data = lxb_encoding_data(LXB_ENCODING_ISO_8859_4);

    size = sizeof(lxb_encoding_single_index_iso_8859_4)
    ...
    for (size_t i = 0; i < size; i++) {
        ...
        entry = &lxb_encoding_single_index_iso_8859_4[i];
...
main(int argc, const char * argv[])
{
    ...
    TEST_RUN("lexbor/encoding/iso_8859_4");
    TEST_RELEASE();
}
