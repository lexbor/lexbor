...
TEST_BEGIN(decode)
{
    ...
    enc_data = lxb_encoding_data(LXB_ENCODING_KOI8_U);

    size = sizeof(lxb_encoding_single_index_koi8_u)
    ...
    for (size_t i = 0; i < size; i++) {
        ...
        entry = &lxb_encoding_single_index_koi8_u[i];
...
main(int argc, const char * argv[])
{
    ...
    TEST_RUN("lexbor/encoding/koi8_u");
    TEST_RELEASE();
}
