...
TEST_BEGIN(decode)
{
    ...
    enc_data = lxb_encoding_data(LXB_ENCODING_MACINTOSH);

    size = sizeof(lxb_encoding_single_index_macintosh)
    ...
    for (size_t i = 0; i < size; i++) {
        ...
        entry = &lxb_encoding_single_index_macintosh[i];
...
main(int argc, const char * argv[])
{
    ...
    TEST_RUN("lexbor/encoding/macintosh");
    TEST_RELEASE();
}
