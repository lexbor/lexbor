...
TEST_BEGIN(decode)
{
    ...
    enc_data = lxb_encoding_data(LXB_ENCODING_WINDOWS_1255);

    size = sizeof(lxb_encoding_single_index_windows_1255)
    ...
    for (size_t i = 0; i < size; i++) {
        ...
        entry = &lxb_encoding_single_index_windows_1255[i];
...
main(int argc, const char * argv[])
{
    ...
    TEST_RUN("lexbor/encoding/windows_1255");
    TEST_RELEASE();
}
