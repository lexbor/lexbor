...
TEST_BEGIN(decode)
{
    ...
    enc_data = lxb_encoding_data(LXB_ENCODING_WINDOWS_1256);

    size = sizeof(lxb_encoding_single_index_windows_1256)
    ...
    for (size_t i = 0; i < size; i++) {
        ...
        entry = &lxb_encoding_single_index_windows_1256[i];
...
main(int argc, const char * argv[])
{
    ...
    TEST_RUN("lexbor/encoding/windows_1256");
    TEST_RELEASE();
}
