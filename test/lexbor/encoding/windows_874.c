...
TEST_BEGIN(decode)
{
    ...
    enc_data = lxb_encoding_data(LXB_ENCODING_WINDOWS_874);

    size = sizeof(lxb_encoding_single_index_windows_874)
    ...
    for (size_t i = 0; i < size; i++) {
        ...
        entry = &lxb_encoding_single_index_windows_874[i];
...
main(int argc, const char * argv[])
{
    ...
    TEST_RUN("lexbor/encoding/windows_874");
    TEST_RELEASE();
}
