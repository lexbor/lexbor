 ...
 *
 * @param[in] lxb_url_parser_t *. Cannot be NULL.
 * @param[in] lxb_char_t *. Cannot be NULL.
 * @param[in] lxb_char_t *. Cannot be NULL.
 * @param[out] uint16_t *. Cannot be NULL. Output buffer for the eight parsed IPv6 pieces.
 *
