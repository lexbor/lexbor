...
#include "lexbor/style/attribute_steps_res.h"


lxb_status_t
lxb_style_attribute_steps_change(lxb_dom_element_t *element,
                                 ...
                                 lxb_ns_id_t ns)
{
    ...
    change = lxb_style_attribute_steps_res_default[element->node.local_name].change;
...
lxb_status_t
lxb_style_attribute_steps_append(lxb_dom_element_t *element,
                                 lxb_dom_attr_id_t name,
                                 const lxb_char_t *old_value, size_t old_len,
                                 const lxb_char_t *value, size_t value_len,
                                 lxb_ns_id_t ns)
{
    ...
    append = lxb_style_attribute_steps_res_default[element->node.local_name].append;
...
lxb_status_t
lxb_style_attribute_steps_remove(lxb_dom_element_t *element,
                                 lxb_dom_attr_id_t name,
                                 const lxb_char_t *old_value, size_t old_len,
                                 const lxb_char_t *value, size_t value_len,
                                 lxb_ns_id_t ns)
{
    ...
    remove = lxb_style_attribute_steps_res_default[element->node.local_name].remove;
...
lxb_status_t
lxb_style_attribute_steps_replace(lxb_dom_element_t *element,
                                  lxb_dom_attr_id_t name,
                                  const lxb_char_t *old_value, size_t old_len,
                                  const lxb_char_t *value, size_t value_len,
                                  lxb_ns_id_t ns)
{
    ...
    replace = lxb_style_attribute_steps_res_default[element->node.local_name].replace;
